...
class AssignTruckWidget extends StatefulWidget {
  final bookingId;
  AssignTruckWidget({Key key , this.bookingId}) : super(key: key);

  @override
  _AssignTruckWidgetState createState() => _AssignTruckWidgetState();
}

class _AssignTruckWidgetState extends State<AssignTruckWidget>
    with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    var truckProvider = Provider.of<BookingProvider>(context);
    return Scaffold(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                              ...
                              children: <Widget>[
                                FlatButton(
                                  onPressed: () async {
                                    var response = await truckProvider.assignTruck(
                                     widget.bookingId, truckProvider.trucks[i]['id']);
                                    if(response['status'] == true) Navigator.of(context).pop(ConfirmAction.ACCEPT);
                                  },
