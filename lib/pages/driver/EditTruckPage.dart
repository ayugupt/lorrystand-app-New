...
class EditTruckPage extends StatefulWidget {
  @override
  _EditTruckWidgetState createState() => _EditTruckWidgetState();
}

class _EditTruckWidgetState extends State<EditTruckPage> {
   var form = {};
   @override
  void initState() {
    super.initState();
  ...
  void _selectTruckType(BuildContext context){
            ...
            pageBuilder: (BuildContext context, _, __) =>
                TruckTypeModal(
                              onSelectedChanged: (trucktypeid) {
                                setState(() {
                                  form['truck_type_id'] = trucktypeid;
                                });                            
  ...
  void _selectTruckCapacity(BuildContext context){
      Navigator.of(context).push(PageRouteBuilder(
            opaque: false,
            pageBuilder: (BuildContext context, _, __) =>
                TruckCapacityModal(
                  truckType : form['truck_type_id'],
                              onSelectedChanged: (trucktypeid) {
                                setState(() {
                                  form['truck_capacity_id'] = trucktypeid;
                                });                            
                                Navigator.of(context).pop();
                              })
            ));
  ...
  void _selectTruckSize(BuildContext context){
      Navigator.of(context).push(PageRouteBuilder(
            opaque: false,
            pageBuilder: (BuildContext context, _, __) =>
                TruckSizeModal(
                   ...
                   capacityIndex : form['truck_capacity_id'],
                              onSelectedChanged: (trucktypeid) {
                                setState(() {
                                  form['truck_size_id'] = trucktypeid;
                                });                            
                                Navigator.of(context).pop();
                              })
            ));
      ...
      child: Scaffold(
        ...
        //mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: <Widget>[
            ...
            GestureDetector(
              onTap: () => _selectTruckType(context),
              child:  Container(
                ...
                child: Text(
                        form['truck_type_id'] == null ? "Select your Source Address" : "${userProvider.truckTypes[form['truck_type_id']]['name']}",
            ...
            GestureDetector(
              onTap: () => _selectTruckCapacity(context),
              child:  Container(
                padding: EdgeInsets.symmetric(vertical: 18.0, horizontal: 16.0),
                decoration: BoxDecoration(
                  color: Color(0xffeeeeee).withOpacity(0.5),
                ...
                child: Text(
                        form['truck_capacity_id'] == null ? "Select Truck Capacity" : "${userProvider.truckTypes[form['truck_type_id']]['capacities'][form['truck_capacity_id']]['name']}",
                        overflow: TextOverflow.fade,
                        style: form['truck_capacity_id'] == null ?  TextStyle(fontSize: 14.0, color: Colors.grey)
                        : new TextStyle(fontSize: 14.0, color: Colors.grey[900]),
                        maxLines: 1,
                      ),
                ),
            ...
            GestureDetector(
              onTap: () => _selectTruckSize(context),
              child:  Container(
                padding: EdgeInsets.symmetric(vertical: 18.0, horizontal: 16.0),
                decoration: BoxDecoration(
                  color: Color(0xffeeeeee).withOpacity(0.5),
                ...
                child: Text(
                        form['truck_size_id'] == null ? "Select Truck Size" : "${userProvider.truckTypes[form['truck_type_id']]['capacities'][form['truck_capacity_id']]['sizes'][form['truck_size_id']]['name']}",
                        overflow: TextOverflow.fade,
                        style: form['truck_size_id'] == null ?  TextStyle(fontSize: 14.0, color: Colors.grey)
                        :new TextStyle(fontSize: 14.0, color: Colors.grey[900]),
                        maxLines: 1,
                      ),
                ),
            ...
            GestureDetector(
              ...
              child:  Container(
                ...
                child: Text(
                        form['city_id'] == null ? "Select City" : "${userProvider.cities[form['city_id']]['name']}",
                        overflow: TextOverflow.fade,
                        style: form['city_id'] == null ? TextStyle(fontSize: 14.0, color: Colors.grey)
                        : new TextStyle(fontSize: 14.0, color: Colors.grey[900]),
                        maxLines: 1,
                      ),
                ),
